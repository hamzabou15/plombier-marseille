...
const StatsCard = () => {
    const stats = [
        { value: 2850, label: 'Dépannages urgents réalisés à Aix-En-Provence' },
        ...
        <section className='py-16' id="chiffres-plomberie-aixenprovence" aria-label="Statistiques Plombier Aix-En-Provence">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 px-4 sm:px-6 text-center mb-12">
                ...
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                    15 ans d&apos;expertise au service des habitants de Aix-En-Provence et du Var
                </p>
            </div>
...
const StatItem = ({ value, label }: { value: number; label: string; }) => {
    ...
    return (
        ...
        >
            <div className="text-4xl md:text-5xl font-bold text-[#E67E22]">
