...
const Introduction = () => {
  return (
    <section className="bg-[#f7f9fa] py-20 px-6 sm:px-8 max-w-6xl mx-auto rounded-xl shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
        <div>
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Fournir un service de plomberie d&apos;urgence rapide, fiable et à prix transparent aux habitants de Aix-En-Provence.
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-700">
            {[
              "Rapidité : Intervention en moins de 30 minutes",
              "SOSise : Plombiers certifiés avec 10+ ans d'expérience",
      ...
      <div className="mt-12 text-center max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Nous intervenons dans tout le <strong>département du Var (83)</strong> : Aix-En-Provence, La Valette-du-Var, La Garde, Le Revest-les-Eaux, Ollioules, La Seyne-sur-Mer, Six-Fours-les-Plages, Sanary-sur-Mer, Bandol, et toutes les communes environnantes.
        </p>
